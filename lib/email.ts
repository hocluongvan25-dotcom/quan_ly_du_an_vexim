      ...
      <div style="margin-top:24px; padding:16px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px">
        ...
        <ul style="margin:8px 0 0 18px; padding:0; font-size:13px; line-height:1.6; color:#334155">
          ${isExpired
            ...
            : `<li>Liên hệ Vexim để được tư vấn gia hạn ${data.standard} (FDA cố định 2 năm, GACC cố định 5 năm)</li><li>Chuẩn bị phí gia hạn và hồ sơ liên quan</li><li>Gia hạn sớm để được giá ưu đãi và tránh phí gấp</li>`}
        </ul>
      </div>
